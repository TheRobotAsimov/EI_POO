...
public class GraficarEdad {
    ...
    public DefaultCategoryDataset datos(){
        ...
        try {
            ...
            ResultSet rs = con.comando.executeQuery("select nombre, timestampdiff(year, fechanac, CURDATE()) as edad from piloto;");
            while(rs.next()){
                datos.addValue(rs.getInt("edad"),rs.getString("nombre"),rs.getString("nombre"));
            }
